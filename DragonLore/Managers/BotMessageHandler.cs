        ...
        public Embed GenerateNewsEmbed(FeedItem newsItem, string source)
        {
            ...
            switch (source)
            {
                case "GosuGamers News":
                    ...
                    {
                        int startPos = newsItem.Description.IndexOf("<p>", StringComparison.Ordinal) + "<p>".Length;
                        int length = newsItem.Description.IndexOf("</p><p>", StringComparison.Ordinal) - startPos;
